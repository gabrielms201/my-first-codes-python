...
while final < inicial:
    inicial = int(input("O número final não deve ser menor que o inicial!\nComeçar por: "))
    final = int(input("O número final não deve ser menor que o inicial!\nTerminar em: "))
for i in range(inicial, final+1):
    mult = i*num
    print("%d x %d = %d" % (num, i, mult))